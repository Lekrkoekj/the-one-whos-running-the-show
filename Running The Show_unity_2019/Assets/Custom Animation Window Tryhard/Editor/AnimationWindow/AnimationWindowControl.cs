...
namespace UnityEditorInternal.Enemeteen {
	internal class AnimationWindowControl : ScriptableObject, IAnimationContextualResponder {
		...
		public UnityEditor.Enemeteen.AnimEditor animEditor { get { return state.animEditor; } }
		...
		public AnimationKeyTime time => m_Time;


		public void StartScrubTime() {
			// nothing to do...
		}

		public void EndScrubTime() {
			// nothing to do...
		}
		...
		public bool playing => AnimationMode.InAnimationPlaybackMode() && previewing;
		...
		public bool StartRecording(Object targetObject) {
