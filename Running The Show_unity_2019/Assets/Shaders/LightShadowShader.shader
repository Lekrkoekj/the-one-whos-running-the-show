Shader "Custom/MultiplyShadowProcedural Light"
{
    Properties
    {
        _Color    ("Tint (RGB only)", Color) = (0,0,0,0)
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float strength = mask * _Darkness / 10;
                float3 finalRGB = _Color.rgb * strength;
                return float4(finalRGB, 0);
            }
            ENDCG
        }
    }
